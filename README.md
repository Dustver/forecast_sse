...
9. Детектор сезонности:
   - если ненулевых точек меньше 4, сезонность = 1 (защита от разреженных рядов).
   ...
   - выбирается лаг с максимальной корреляцией; если максимум не положительный или ниже порога 0.3, возвращается 1.
